...
//
//    @Autowired
//    private ListOfEmployeesOfOneCompanyService listOfEmployeesOfOneCompanyService;
//
//    @Value("${api.key.prod}")
//    String apiKey;
//
...
//            listOfPeople.addAll(listOfEmployeesOfOneCompanyService.creationOfEmployees(employeeInfoList.get(i)));
//        }
//
